...
<body>
						...
						<div class="row no-gutters">
							<div class="col-md-2">
								<div class="top-category text-center no-border-left">
									<h3><a href="#">Customer Success Support</a></h3>
							...
							<div class="col-md-2">
								<div class="top-category text-center">
									<h3><a href="#">Helpdesk & Ticketing Chat</a></h3>
							...
							<div class="col-md-2">
								<div class="top-category text-center">
									<h3><a href="#">Trading Operations Chat</a></h3>
							...
							<div class="col-md-2">
								<div class="top-category text-center">
									<h3><a href="#">VIP Trader Support</a></h3>
							...
							<div class="col-md-2">
								<div class="top-category text-center">
									<h3><a href="#">Technical Product Support</a></h3>
							...
							<div class="col-md-2">
								<div class="top-category text-center">
									<h3><a href="#">Onboarding & Implementation</a></h3>
		...
		<div class="container">
			<div class="row justify-content-center mb-5">
				<div class="col-md-7 heading-section text-center ftco-animate">
					...
					<h2 class="mb-0">This Is Us</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-12">
					<video class="ratio w-100" controls autoplay loop playsinline poster="images/play_yellow.png">
	...
	<section class="ftco-section">
		<div class="container">
			<div class="row justify-content-center mb-5">
				<div class="col-md-7 heading-section text-center ftco-animate">
					<span class="subheading">Support Categories</span>
					<h2 class="mb-0">Our Chat Support Services</h2>
				</div>
			</div>
	...
	<section class="ftco-section">
		<div class="apply-process-area apply-bg pt-150 pb-150" data-background="images/stepsbg.png">
		...
		<div class="container">
			<div class="row justify-content-center mb-4">
				<div class="col-md-7 text-center heading-section ftco-animate">
					...
					<h2 class="mb-4">What People Say About EasyHire</h2>
				</div>
			</div>
					...
					<div class="carousel-testimony owl-carousel ftco-owl">
						<div class="item">
							<div class="testimony-wrap py-4">
								<div class="text">
									<p class="mb-4">EasyHire made my job search so simple. I applied to a few jobs and
										got interview calls within days. The process was smooth and easy to follow.</p>
									<div class="d-flex align-items-center">
										<div class="user-img" style="background-image: url(images/person_1.jpg)"></div>
										<div class="pl-3">
											<p class="name">Rahul Sharma</p>
											<span class="position">Sales Executive-Payments</span>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="item">
							<div class="testimony-wrap py-4">
								<div class="text">
									<p class="mb-4">As a small business owner, finding the right candidate was always
										difficult. EasyHire helped me receive genuine applications quickly.</p>
									<div class="d-flex align-items-center">
										<div class="user-img" style="background-image: url(images/person_2.jpg)"></div>
										<div class="pl-3">
											<p class="name">Abhishek Verma</p>
											<span class="position">Customer Support Lead</span>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="item">
							<div class="testimony-wrap py-4">
								<div class="text">
									<p class="mb-4">I liked how simple the platform is. No confusion, no unnecessary
										steps - just apply and wait for a response from employers.</p>
									<div class="d-flex align-items-center">
										<div class="user-img" style="background-image: url(images/person_3.jpg)"></div>
										<div class="pl-3">
											<p class="name">Amit Patel</p>
						...
						<div class="item">
							<div class="testimony-wrap py-4">
								<div class="text">
									<p class="mb-4">EasyHire helped me find a job that matched my experience. The
										employers contacted me directly and the process felt very transparent.</p>
									<div class="d-flex align-items-center">
										<div class="user-img" style="background-image: url(images/person_1.jpg)"></div>
										<div class="pl-3">
											<p class="name">Akash Singh</p>
						...
						<div class="item">
							<div class="testimony-wrap py-4">
								<div class="text">
									<p class="mb-4">For a new hiring platform, EasyHire works really well. We received
										quality resumes and filled our vacancy faster than expected.</p>
									<div class="d-flex align-items-center">
										<div class="user-img" style="background-image: url(images/person_2.jpg)"></div>
										<div class="pl-3">
											<p class="name">Arjun Mehta</p>
											<span class="position">Startup Founder</span>
										</div>
									</div>
								</div>
							</div>
