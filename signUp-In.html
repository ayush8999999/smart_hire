...
<body>
				...
				<div class="form-wrapper align-items-center">
					<form class="form sign-up" method="POST" action="signup.php">
						<div class="input-group">
                            ...
                            <div class="input-error">Please input a valid full name</div>
						</div>
                        <!-- <div class="input-group">
						...
						<div class="input-group">
                            ...
                            <div class="input-error">Please input a valid email address</div>
						</div>
						<div class="input-group">
                            <div class="input-wrapper">
                            ...
                            <div class="input-error">Password should be 8 or more characters</div>
						</div>
						<div class="input-group">
                            <div class="input-wrapper">
                                <i class='bx bxs-lock-alt icon-left'></i>
                            ...
                            <div class="input-error">Confirm password does not match the password</div>
						</div>
						<button type="submit">
							Sign Up
						</button>
    ...
    <script>
        document.addEventListener("keydown", (e) => {
            if (
                (e.target.name === "email" || e.target.name === "password" || e.target.name === "confirm_password") &&
                e.key === " "
            ) {
                e.preventDefault();
            }
        ...
        function setError(group, msg) {
            ...
            group.querySelector(".input-error").innerText = msg;
        }
        ...
        function validateFullName(input) {
            ...
            input.value.trim().length >= 2
                ? setSuccess(group)
                : setError(group, "Please input a valid full name");
        }
        ...
        function validateEmail(input) {
            ...
            /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(input.value)
                ? setSuccess(group)
                : setError(group, "Please input a valid email address");
        }
        ...
        function validatePassword(input) {
            ...
            input.value.length >= 8
                ? setSuccess(group)
                : setError(group, "Password should be 8 or more characters");
        }
        ...
        function validateConfirmPassword(confirm, password) {
            ...
            confirm.value === password.value && confirm.value !== ""
                ? setSuccess(group)
                : setError(group, "Confirm password does not match the password");
        }

        function resetFieldState(input) {
            const group = input.closest(".input-group");

            group.classList.remove("error", "success", "has-value", "phone-valid", "phone-invalid");
        }

        const signup = document.querySelector(".form.sign-up");

        signup.full_name.addEventListener("input", e => validateFullName(e.target));
        signup.email.addEventListener("input", e => validateEmail(e.target));
        signup.password.addEventListener("input", e => validatePassword(e.target));
        signup.confirm_password.addEventListener("input", e =>
            validateConfirmPassword(e.target, signup.password)
        );
        ...
        function validatePhone() {
            ...
            // 👇 CRITICAL FIX: pass NATIONAL number with country
        ...
        document.addEventListener("input", (e) => {
            if (!e.target.matches(".input-group input")) return;
        ...
        document.querySelectorAll(".clear-input").forEach(icon => {
            ...
            icon.addEventListener("click", () => {
                ...
                // intl-tel-input reset (only for mobile)
                if (input.id === "mobile" && window.iti) {
                    iti.setNumber("");
                }
        ...
        signupForm.addEventListener("submit", async (e) => {
            ...
            validateConfirmPassword(signup.confirm_password, signup.password);
